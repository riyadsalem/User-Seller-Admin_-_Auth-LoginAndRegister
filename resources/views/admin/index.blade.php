...
<header class="header_area">
        ...
        <div class="sidebar_logo">
          <a href="index.html">
            <img
              src="{{ asset('panel/assets/images/logo.png') }}"
              alt=""
              class="img-fluid logo1"
            />
            <img
              src="{{ asset('panel/assets/images/logo_small.png') }}"
              alt=""
              ...
              <ul class="dropdown_body nice_scroll scrollbar">
                <li>
                  <a href="#">
                    <div class="img-part">
                      <img
                        src="{{ asset('panel/assets/images/user1.jpg') }}"
                        alt=""
                        class="img-fluid"
                      />
                    </div>
                ...
                <li>
                  <a href="#">
                    <div class="img-part">
                      <img
                        src="{{ asset('panel/assets/images/user2.jpg') }}"
                        alt=""
                        class="img-fluid"
                      />
                    </div>
                ...
                <li>
                  <a href="#">
                    <div class="img-part">
                      <img
                        src="{{ asset('panel/assets/images/user3.jpg') }}"
                        alt=""
                        class="img-fluid"
                      />
                    </div>
      ...
      <div class="content_wrapper">
        ...
        <p>  Login Admin Name:<b><cite title="Source Title">{{ Auth::guard('admin')->user()->name }}</cite></b></p>
        <p>  Login Admin Email:<b><cite title="Source Title">{{ Auth::guard('admin')->user()->email }}</cite></b></p>
